import React$1, { ReactNode, createElement } from "react";
import { APIKeysProps, AlertId, BuiltInColors, CardActionId, Clerk, CreateOrganizationProps, EnterpriseProvider, FieldId, InitialState, InternalClerkScriptProps, IsomorphicClerkOptions, LoadedClerk, MenuId, OAuthDeviceVerificationProps, OAuthProvider, OrganizationListProps, OrganizationPreviewId, OrganizationProfileProps, OrganizationSwitcherProps, PhoneCodeChannel, ProfilePageId, ProfileSectionId, RedirectUrlProp, SamlIdpSlug, SelectId, SignInProps, SignInRedirectOptions, SignUpProps, SignUpRedirectOptions, TaskChooseOrganizationProps, TaskResetPasswordProps, TaskSetupMFAProps, TasksRedirectOptions, TransparentColor, UserAvatarProps, UserButtonProps, UserPreviewId, UserProfileProps, WaitlistProps, Web3Provider } from "@clerk/shared/types";
import { ClerkUIConstructor } from "@clerk/shared/ui";
//#region ../../node_modules/.pnpm/csstype@3.1.3/node_modules/csstype/index.d.ts
...
//#endregion
//#region ../ui/dist/internal/appearance.d.ts
//#region src/internal/appearance.d.ts
...
type CSSPseudos = { [K in Pseudos as `&${K}`]?: CSSObject };
...
type AlphaColorScale<T = string> = { [K in Shade]: T };
...
type FontWeightNamedValue = Properties['fontWeight'];
...
//#endregion
//#region ../ui/dist/internal/index.d.ts
 ...
 */
type ExtractAppearanceType<T, Default> = T extends {
  __appearanceType?: infer A;
} ? 0 extends 1 & A ? Default : A : Default;
//#endregion
...
//# sourceMappingURL=types-8bkUI4Jw.d.mts.map