const require_hooks = require('./hooks-ByQmbuum.cjs');
...
let _clerk_shared_internal_clerk_js_windowNavigate = require("@clerk/shared/internal/clerk-js/windowNavigate");
	...
	*/
	...
	constructor(options) {
		...
		this.__internal_windowNavigate = (to, opts) => {
			...
			if (!(0, _clerk_shared_browser.inBrowser)()) return;
			(0, _clerk_shared_internal_clerk_js_windowNavigate.windowNavigate)(to, { allowedProtocols: opts?.useStaticAllowlistOnly ? _clerk_shared_internal_clerk_js_windowNavigate.ALLOWED_PROTOCOLS : [..._clerk_shared_internal_clerk_js_windowNavigate.ALLOWED_PROTOCOLS, ...this.options.allowedRedirectProtocols ?? []] });
		};
...
function ClerkProviderGuard(props) {
	if (react.default.useContext(_clerk_shared_react.ClerkInstanceContext)) require_useAssertWrappedByClerkProvider.errorThrower.throw(require_hooks.multipleClerkProvidersError);
	return /* @__PURE__ */ react.default.createElement(ClerkProviderBase, props);
}
...
//# sourceMappingURL=ClerkProvider-DVU7wqPV.cjs.map