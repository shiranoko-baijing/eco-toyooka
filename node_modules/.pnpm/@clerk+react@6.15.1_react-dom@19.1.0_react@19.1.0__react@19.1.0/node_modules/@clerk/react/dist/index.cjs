...
const require_ClerkProvider = require('./ClerkProvider-DVU7wqPV.cjs');
...
* ```
*/
const InviteMembersButton = require_hooks.withClerk(({ clerk, children, ...props }) => {
	const { appearance, getContainer, component, ...rest } = props;
	children = require_hooks.normalizeWithDefaultValue(children, "Invite members");
	const child = require_hooks.assertSingleChild(children)("InviteMembersButton");
	const clickHandler = () => {
...
exports.InviteMembersButton = InviteMembersButton;
exports.OAuthConsent = require_hooks.OAuthConsent;
exports.OAuthDeviceVerification = require_hooks.OAuthDeviceVerification;
...
Object.defineProperty(exports, 'useOAuthDeviceVerification', {
  enumerable: true,
  get: function () {
    return _clerk_shared_react.useOAuthDeviceVerification;
  }
});
