...
* ```
*/
const OAuthDeviceVerification = withClerk(({ clerk, component, fallback, ...props }) => {
	const shouldShowFallback = useWaitForComponentMount(component) === "rendering" || !clerk.loaded;
	const rendererRootProps = { ...shouldShowFallback && fallback && { style: { display: "none" } } };
	return /* @__PURE__ */ React.createElement(React.Fragment, null, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ React.createElement(ClerkHostRenderer, {
		component,
		...
		updateProps: (props) => void clerk.__internal_updateProps(props),
		props,
		rootProps: rendererRootProps
	}));
}, {
...
//#endregion
export { OrganizationSwitcher as A, Waitlist as B, APIKeys as C, OAuthDeviceVerification as D, OAuthConsent as E, TaskResetPassword as F, normalizeWithDefaultValue as G, isConstructor as H, TaskSetupMFA as I, multipleClerkProvidersError as J, safeExecute as K, UserAvatar as L, SignIn as M, SignUp as N, OrganizationList as O, TaskChooseOrganization as P, UserButton as R, useDerivedAuth as S, GoogleOneTap as T, mergeWithEnv as U, withClerk as V, assertSingleChild as W, unsupportedNonBrowserDomainOrProxyUrlFunction as X, noPathProvidedError as Y, useSignIn as _, __experimental_usePaymentElement as a, useEmailLink as b, useOAuthConsent$1 as c, useOrganizationCreationDefaults as d, useOrganizationList as f, useUser as g, useSessionList as h, __experimental_useCheckout as i, PricingTable as j, OrganizationProfile as k, useOAuthDeviceVerification as l, useSession as m, __experimental_PaymentElement as n, useAPIKeys as o, useReverification as p, incompatibleRoutingWithPathProvidedError as q, __experimental_PaymentElementProvider as r, useClerk as s, __experimental_CheckoutProvider as t, useOrganization as u, useSignUp as v, CreateOrganization as w, useAuth as x, useWaitlist as y, UserProfile as z };
//# sourceMappingURL=hooks-66XwX3F0.mjs.map